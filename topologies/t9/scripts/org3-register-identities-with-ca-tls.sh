...
CA_PRIV_KEYFILE=`find_private_key_path /tmp/crypto-material/cas/org3/ca-tls`
...
cp $CA_PRIV_KEYFILE /tmp/crypto-material/cas/org3/ca-tls/msp/keystore/key.pem
export FABRIC_CA_CLIENT_TLS_CLIENT_KEYFILE=/tmp/crypto-material/cas/org3/ca-tls/msp/keystore/key.pem
export FABRIC_CA_CLIENT_TLS_CLIENT_CERTFILE=/tmp/crypto-material/cas/org3/ca-tls/tls-cert.pem
...
sleep 1
mv /tmp/crypto-material/cas/org3/ca-tls-admin/msp/keystore/* /tmp/crypto-material/cas/org3/ca-tls-admin/msp/keystore/key.pem
