...
peer lifecycle chaincode commit --channelID mychannel --name myccv1 --version "1.0" \
    ...
    --tlsRootCertFiles /tmp/crypto-material/cas/org3/ca-tls/ca-cert.pem \
    --sequence 1 --tls --cafile /tmp/crypto-material/cas/org1/ca-tls/ca-cert.pem --clientauth \
    --keyfile /tmp/crypto-material/orgs/org1/admins/admin-tls/msp/keystore/key.pem \
    --certfile /tmp/crypto-material/orgs/org1/admins/admin-tls/msp/signcerts/cert.pem
