...
export CC_ID=`docker exec ${CURRENT_HL_TOPOLOGY}-org2-cli-peer1 /bin/sh -c  "/tmp/scripts/org2-get-installed-cc-id.sh"`
docker exec ${CURRENT_HL_TOPOLOGY}-org2-cli-peer1 /bin/sh -c "/tmp/scripts/org2-create-cas-tls-private-tls-key-file.sh"
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/chaincode/org2-chaincode/docker-compose-org2-chaincode.yml up -d org2-chaincode

docker exec ${CURRENT_HL_TOPOLOGY}-org3-cli-peer1 /bin/sh -c  "/tmp/scripts/org3-install-chaincode.sh"
export CC_ID=`docker exec ${CURRENT_HL_TOPOLOGY}-org3-cli-peer1 /bin/sh -c  "/tmp/scripts/org3-get-installed-cc-id.sh"`
docker exec ${CURRENT_HL_TOPOLOGY}-org3-cli-peer1 /bin/sh -c "/tmp/scripts/org3-create-cas-tls-private-tls-key-file.sh"
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/chaincode/org3-chaincode/docker-compose-org3-chaincode.yml up -d org3-chaincode
