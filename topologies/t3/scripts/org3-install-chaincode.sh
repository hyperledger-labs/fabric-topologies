...
cd /tmp/assets/chaincode/assets-transfer-basic/config/org3
...
cp /tmp/crypto-material/cas/org3/ca-tls/ca-cert.pem peers.pem
#cat /tmp/crypto-material/cas/org3/ca-tls/ca-cert.pem /tmp/crypto-material/peers/org3/peer1/node-tls/msp/signcerts/cert.pem /tmp/crypto-material/peers/org3/peer2/node-tls/msp/signcerts/cert.pem > peers.pem
