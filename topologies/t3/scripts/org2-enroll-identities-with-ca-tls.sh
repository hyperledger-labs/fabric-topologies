...
# enroll org2 chaincode
export FABRIC_CA_CLIENT_HOME=/tmp/crypto-material/orgs/org2/chaincode
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org2/ca-tls/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://chaincode-org2:chaincodeOrg2PW@0.0.0.0:7054 --enrollment.profile tls --csr.hosts ${TOPOLOGY}-org2-chaincode
mv /tmp/crypto-material/orgs/org2/chaincode/msp/keystore/* /tmp/crypto-material/orgs/org2/chaincode/msp/keystore/key.pem
chmod -R 777 /tmp/crypto-material/orgs/org2/chaincode/msp
