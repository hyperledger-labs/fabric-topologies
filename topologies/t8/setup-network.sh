...
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
    -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/docker-compose-shell-cmd-utils.yml up -d
...
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   ...
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/peers/org2-peers/docker-compose-org2-couchdb.yml up -d org2-peer1-couchdb1

docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/peers/org2-peers/docker-compose-org2-couchdb.yml up -d org2-peer1-couchdb2

sleep 3

docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/peers/org2-peers/docker-compose-org2-couchdb.yml up -d org2-peer1-couchdb-proxy

# Configure Couch DB cluster for org2 peer1
docker exec ${CURRENT_HL_TOPOLOGY}-shell-cmd /bin/sh -c "/bin/sh /tmp/scripts/org2-peer1-setup-couchdb-cluster.sh"
