...
fabric-ca-client enroll -d -u https://org1-identities-orderer1:orderer1PW@0.0.0.0:7054 --csr.names "C=US,ST=Washington"
...
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org1/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://org1-identities-orderer2:orderer2PW@0.0.0.0:7054 --csr.names "C=US,ST=Washington"
...
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org1/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://org1-identities-orderer3:orderer3PW@0.0.0.0:7054 --csr.names "C=US,ST=Washington"
