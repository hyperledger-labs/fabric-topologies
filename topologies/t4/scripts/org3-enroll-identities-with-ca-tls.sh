...
fabric-ca-client enroll -d -u https://org3-tls-peer1:peer1PW@0.0.0.0:7054 --csr.names "C=US,ST=Washington" --enrollment.attrs "hf.Type,hf.EnrollmentID,hf.Affiliation" --enrollment.profile tls --csr.hosts ${TOPOLOGY}-org3-peer1

# enroll peer2 node-tls
export FABRIC_CA_CLIENT_HOME=/tmp/crypto-material/peers/org3/peer2/node-tls
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org3/ca-tls/ca-cert.pem
fabric-ca-client enroll -d -u https://org3-tls-peer2:peer2PW@0.0.0.0:7054 --csr.names "C=US,ST=Washington" --enrollment.attrs "hf.Type,hf.EnrollmentID,hf.Affiliation" --enrollment.profile tls --csr.hosts ${TOPOLOGY}-org3-peer2
