...
# -----------------------------------------------------------------------------
# -----setup the OpenLDAD servers for all orgs -----
# -----------------------------------------------------------------------------
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas-openldap.yml up -d org1-ca-openldap
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org2-cas/docker-compose-org2-cas-openldap.yml up -d org2-ca-openldap
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org3-cas/docker-compose-org3-cas-openldap.yml up -d org3-ca-openldap
# -----------------------------------------------------------------------------
# -----setup the CAs for all orgs-----
# -----registration of accounts not needed since acccounts are setup inside OpenLDAP
# -----------------------------------------------------------------------------
# -----org1 CAs
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
