...
fabric-ca-client enroll -d -u https://org1-orderer1:orderer1PW@0.0.0.0:9000 
...
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org1/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://org1-orderer2:orderer2PW@0.0.0.0:9000
...
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org1/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://org1-orderer3:orderer3PW@0.0.0.0:9000
...
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org1/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://admin-org1:org1adminpw@0.0.0.0:9000
