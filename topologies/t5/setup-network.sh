...
# -----Setup CA DBs -----
mkdir -p ${HL_TOPOLOGIES_BASE_FOLDER}/homefolders/org1/ca-db/data
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas-db.yml up -d org1-ca-db
sleep 33
...
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas.yml up -d org1-ca-tls-n0
sleep 10
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas.yml up -d org1-ca-tls-n1
sleep 2
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas-proxy.yml up -d org1-ca-tls
sleep 2
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas.yml up -d org1-ca-identities-n0
sleep 10
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas.yml up -d org1-ca-identities-n1
sleep 2
docker compose --env-file ${HL_TOPOLOGIES_BASE_FOLDER}/.env -f ${HL_TOPOLOGIES_BASE_FOLDER}/../docker-compose-base.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/docker-compose.yml \
   -f ${HL_TOPOLOGIES_BASE_FOLDER}/containers/cas/org1-cas/docker-compose-org1-cas-proxy.yml up -d org1-ca-identities
sleep 7

docker exec ${CURRENT_HL_TOPOLOGY}-org1-ca-tls-n0 /bin/sh -c "/bin/sh /tmp/scripts/org1-register-identities-with-ca-tls.sh"
docker exec ${CURRENT_HL_TOPOLOGY}-org1-ca-identities-n0 /bin/sh -c "/bin/sh /tmp/scripts/org1-register-identities-with-ca-identities.sh"
...
docker exec ${CURRENT_HL_TOPOLOGY}-org1-ca-tls-n0 /bin/sh -c "/bin/sh /tmp/scripts/org1-enroll-identities-with-ca-tls.sh"
docker exec ${CURRENT_HL_TOPOLOGY}-org1-ca-identities-n0 /bin/sh -c "/bin/sh /tmp/scripts/org1-enroll-identities-with-ca-identities.sh"

# -----generate the genesis.block and mychannel artifacts
...
docker exec ${CURRENT_HL_TOPOLOGY}-org3-cli-peer1 /bin/sh -c "/tmp/scripts/org3-create-and-join-channels.sh"
