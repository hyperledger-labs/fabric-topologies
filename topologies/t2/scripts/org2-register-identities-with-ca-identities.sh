...
fabric-ca-client register -d --id.name org2-orderer1 --id.secret orderer1PW --id.type orderer -u https://0.0.0.0:7054
fabric-ca-client register -d --id.name org2-orderer2 --id.secret orderer2PW --id.type orderer -u https://0.0.0.0:7054