...
# enroll peer2 node
export FABRIC_CA_CLIENT_HOME=/tmp/crypto-material/peers/org2/peer2/node
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org2/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://peer2-org2:peer2PW@0.0.0.0:7054
mv /tmp/crypto-material/peers/org2/peer2/node/msp/cacerts/* /tmp/crypto-material/peers/org2/peer2/node/msp/cacerts/ca-cert.pem
cp /tmp/config/config.yaml /tmp/crypto-material/peers/org2/peer2/node/msp

# enroll orderer1 node
export FABRIC_CA_CLIENT_HOME=/tmp/crypto-material/orderers/org2/orderer1/node
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org2/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://org2-orderer1:orderer1PW@0.0.0.0:7054 
mv /tmp/crypto-material/orderers/org2/orderer1/node/msp/cacerts/* /tmp/crypto-material/orderers/org2/orderer1/node/msp/cacerts/ca-cert.pem
cp /tmp/config/config.yaml /tmp/crypto-material/orderers/org2/orderer1/node/msp

# enroll orderer2 node
export FABRIC_CA_CLIENT_HOME=/tmp/crypto-material/orderers/org2/orderer2/node
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org2/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://org2-orderer2:orderer2PW@0.0.0.0:7054
mv /tmp/crypto-material/orderers/org2/orderer2/node/msp/cacerts/* /tmp/crypto-material/orderers/org2/orderer2/node/msp/cacerts/ca-cert.pem
cp /tmp/config/config.yaml /tmp/crypto-material/orderers/org2/orderer2/node/msp
...
cp /tmp/crypto-material/cas/org3/ca-tls/ca-cert.pem /tmp/crypto-material/orgs/org2/msp/tlscacerts/org3-tls-ca-cert.pem
