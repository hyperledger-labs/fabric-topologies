...
# enroll peer3 node
export FABRIC_CA_CLIENT_HOME=/tmp/crypto-material/peers/org3/peer3/node
export FABRIC_CA_CLIENT_TLS_CERTFILES=/tmp/crypto-material/cas/org3/ca-identities/ca-cert.pem
fabric-ca-client enroll -d -u https://peer3-org3:peer3PW@0.0.0.0:7054
mv /tmp/crypto-material/peers/org3/peer3/node/msp/cacerts/* /tmp/crypto-material/peers/org3/peer3/node/msp/cacerts/ca-cert.pem
cp /tmp/config/config.yaml /tmp/crypto-material/peers/org3/peer3/node/msp
